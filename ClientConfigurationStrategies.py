...
This strategy at the beginning of each round chooses a sample (defined by sample_size) of clients to run a federated learning training.
There is no data quality poisoning applied.
...
This strategy at the beginning of the first round chooses a sample (defined by sample_size) of clients to run a federated learning training. 
